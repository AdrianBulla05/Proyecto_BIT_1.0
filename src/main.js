...
////Declaracion de variables para la funcion de ocultar el menu de registrar y hacer el login de los usuarios
...
//Funcion para el ocultamiento de los menus de registro y login de los usuarios
